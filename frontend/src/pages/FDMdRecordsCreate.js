  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({
        ...
        diseaseName: "",
        spreadStatus: "",
        spreadArea: "", // Reset new field too
        treatments: "",
        notes: "",
        status: "",
      });
      ...
      <div className="p-6 bg-green-100 min-h-screen flex items-center justify-center">
        <div className="max-w-lg w-full bg-white p-6 shadow-lg rounded-lg border-2 border-green-500">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Treatments */}
            <div>
              <label className="block text-sm font-medium text-gray-700">Treatments (ROP No)</label>
              <input
                type="text"
                name="treatments"
                ...
                pattern="^[A-Za-z0-9]{7}$"
                maxLength="7"
                title="Only letters and positive numbers are allowed (exactly 7 characters, no spaces)"
              />
            </div>
