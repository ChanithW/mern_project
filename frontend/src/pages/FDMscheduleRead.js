      ...
      <div className="max-w-8xl mx-auto bg-white p-6 shadow-lg rounded-lg border-2 border-green-500">
        ...
        <div className="flex justify-between items-center mb-4">
          <button
            ...
            onClick={() => navigate("/fdm-dashboard")}
          >
            Back
          </button>
          <input
          ...
          <table className="w-full table-auto border-collapse border border-green-400">
            <thead>
              <tr className="bg-green-600 text-white">
                ...
                <th className="p-2 border border-green-400">Urea</th>
                <th className="p-2 border border-green-400">ERP</th>
                <th className="p-2 border border-green-400">MOP</th>
